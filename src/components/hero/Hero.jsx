  ...
  return (
    <div className={`bg-${theme} h-auto  pt-24 pb-8 ${theme === "dark" ? "bg-slate-300" : "bg-bodyColor" }`}>
       ...
       <motion.div 
              ...
              >
        <div>
          <h1 className={`text-3xl md:text-4xl font-bold ${theme === 'dark' ? 'text-black' : 'text-white'}`}>Hi, I'm Ganiyat 👋</h1>
